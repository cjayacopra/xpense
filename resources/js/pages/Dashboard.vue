        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <div class="flex flex-col gap-2">
                ...
                <p class="font-medium text-muted-foreground">
                    Welcome back to <span class="text-primary">Xpense</span>.
                </p>
            </div>

            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                <Card
                    class="overflow-hidden glass-card border-none bg-gradient-to-br from-primary/10 to-primary/5 text-card-foreground"
                >
                    <CardHeader
                ...
                <Card
                    class="overflow-hidden glass-card border-none bg-gradient-to-br from-destructive/10 to-destructive/5 text-card-foreground"
                >
                    <CardHeader
                        class="flex flex-row items-center justify-between space-y-0 pb-2"
                    >
                        <CardTitle class="text-sm font-medium"
                            >Monthly Spending</CardTitle
                        >
                        <div
                    ...
                    <CardContent>
                        <div
                            class="text-3xl font-bold tracking-tight text-destructive"
                        >
                            PHP {{ stats?.this_month_expenses || '0.00' }}
                        </div>
                        <div
                            class="mt-1 flex items-center text-xs text-muted-foreground"
                        >
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
                ...
                <Card
                    class="col-span-full glass-card border-none bg-card/50 lg:col-span-4"
                >
                    <CardHeader>
                        <CardTitle class="text-xl font-bold"
                            >Transaction Trends</CardTitle
                        >
                    ...
                    <CardContent>
                        <div
                            class="flex h-[240px] items-end justify-between gap-4 pt-8 pb-2"
                        >
                            <div
                                v-for="day in props.chart_data || []"
                                :key="day.day"
                                class="flex h-full flex-1 flex-col items-center justify-end gap-3"
                            >
                                <div
                                    class="relative flex h-full w-full items-end justify-center gap-1.5"
                                >
                                    <!-- Income Bar -->
                                    <div
                                        class="w-4 rounded-t-lg bg-green-500 shadow-lg shadow-green-500/20 transition-all hover:scale-110 hover:brightness-110"
                                        :style="{
                                            height: `${Math.max((day.income / maxChartValue) * 100, 2)}%`,
                                        }"
                                    ...
                                    <div
                                        ...
                                        :style="{
                                            height: `${Math.max((day.expenses / maxChartValue) * 100, 2)}%`,
                                        }"
                        ...
                        <div
                            class="mt-8 flex justify-center gap-6 text-xs font-bold"
                        >
                ...
                <!-- Recent Transactions -->
                <Card
                    class="col-span-full glass-card border-none bg-card/50 lg:col-span-3"
                >
                    <CardHeader
                    ...
                    >
                        ...
                        <Button
                            ...
                            as-child
                            size="sm"
                            class="rounded-full border-none glass"
                        >
                    ...
                    <CardContent>
                        <div class="space-y-4">
                            <div
                                v-for="transaction in recent_expenses?.data ||
                                []"
                                :key="transaction.id"
                            ...
                            <div
                                v-if="!recent_expenses?.data?.length"
