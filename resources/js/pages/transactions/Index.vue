    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <Dialog v-model:open="isCreateModalOpen">
                    <DialogTrigger as-child>
                        <Button
                            ...
                            class="rounded-full px-6 shadow-lg shadow-primary/20"
                        >
                            <Plus class="mr-2 h-4 w-4" />
                            Add Record
                        </Button>
                    </DialogTrigger>
                    <DialogContent class="max-w-md border-none glass">
                        <form @submit.prevent="submitCreate">
                            ...
                            <div class="grid gap-6 py-4">
                                <div
                                    class="flex gap-1 rounded-2xl bg-muted p-1"
                                >
                                    <Button
                                        type="button"
                                ...
                                <div class="grid gap-2">
                                    ...
                                    <select
                                        ...
                                        class="flex h-10 w-full rounded-xl border border-input bg-background/50 px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
                                        required
                                    >
                                        <option
                                ...
                                <div
                                    ...
                                    class="grid animate-in gap-2 fade-in slide-in-from-top-2"
                                >
                                    ...
                                    <select
                                        ...
                                        v-model="
                                            createForm.destination_account_id
                                        "
                                    ...
                                    >
                                        ...
                                        <option
                                            v-for="account in accounts?.data?.filter(
                                                (a) =>
                                                    a.id !==
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                <Card
                    class="glass-card border-none bg-gradient-to-br from-green-500/10 to-green-500/5"
                >
                    <CardHeader class="pb-2">
                        <CardTitle
                            class="text-xs font-bold tracking-widest text-green-600/70 uppercase"
                            >Total Income</CardTitle
                        >
                    </CardHeader>
                    <CardContent>
                        <div
                            class="text-3xl font-black tracking-tight text-green-600"
                        >
                ...
                <Card
                    class="glass-card border-none bg-gradient-to-br from-destructive/10 to-destructive/5"
                >
                    <CardHeader class="pb-2">
                        <CardTitle
                            class="text-xs font-bold tracking-widest text-destructive/70 uppercase"
                            >Total Spending</CardTitle
                        >
                    </CardHeader>
                    <CardContent>
                        <div
                            class="text-3xl font-black tracking-tight text-destructive"
                        >
                            PHP {{ formatCurrency(totalExpenses) }}
                        </div>
                    </CardContent>
                </Card>
            </div>
            ...
            <!-- History Table -->
            <Card class="overflow-hidden glass-card border-none bg-card/50">
                        ...
                        <table class="w-full caption-bottom text-sm">
                            <thead class="bg-muted/30">
                                <tr class="border-b border-border/50">
                                    <th
                                        class="h-14 px-6 text-left align-middle text-[10px] font-bold tracking-widest text-muted-foreground uppercase"
                                    >
                                        Type
                                    </th>
                                    <th
                                    ...
                                    <th
                                        class="h-14 px-6 text-right align-middle text-[10px] font-bold tracking-widest text-muted-foreground uppercase"
                                    >
                                        Amount
                                    </th>
                                    <th
                            ...
                            <tbody class="[&_tr:last-child]:border-0">
                                <tr
                                    v-for="transaction in expenses?.data || []"
                                    :key="transaction.id"
                                    class="group border-b border-border/50 transition-all hover:bg-accent/30"
                                >
                                    <td class="p-6 align-middle">
                                        ...
                                        <div
                                            v-else
                                            class="flex h-10 w-10 items-center justify-center rounded-xl bg-red-100 text-red-600 dark:bg-red-900/30"
                                        >
                                    ...
                                    <td class="p-6 align-middle">
                                        <div class="flex flex-col gap-0.5">
                                            ...
                                            <span
                                                ...
                                                class="flex items-center gap-1.5 text-[10px] font-bold tracking-widest uppercase"
                                                :style="{
                                    ...
                                    <td
                                        class="max-w-[200px] p-6 align-middle font-medium"
                                    >
                                        <div class="truncate">
                                            {{
                                    ...
                                    <td class="p-6 text-right align-middle">
                                        ...
                                        >
                                            <Button
                                                ...
                                                "
                                                class="rounded-full transition-colors hover:bg-primary/10 hover:text-primary"
                                            >
                                                <Edit2 class="h-4 w-4" />
                                            </Button>
                                            <Button
                                                ...
                                                "
                                                class="rounded-full transition-colors hover:bg-destructive/10 hover:text-destructive"
                                            >
                                ...
                                <tr v-if="!expenses?.data?.length">
                                    <td
                                        colspan="6"
                                        class="p-24 text-center text-muted-foreground"
                                    >
                                        <div
                                            class="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-3xl bg-muted/50"
                                        >
                                            <Receipt
            ...
            <Dialog v-model:open="isEditModalOpen">
                <DialogContent class="max-w-md border-none glass">
                    <form @submit.prevent="submitUpdate">
                        ...
                        <div class="grid gap-6 py-4">
                            <div class="flex gap-1 rounded-2xl bg-muted p-1">
                                <Button
                                    type="button"
